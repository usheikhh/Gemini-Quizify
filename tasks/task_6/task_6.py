...
if __name__ == "__main__":
    ...
    with screen.container():
        ...
        with st.form("Load Data to Chroma"):
            ...
            number_of_questions = st.slider(label = "slider to input desired number of question", min_value=1, max_value=10)
            ...
            if submitted:
                ...
                # following lines to test the query_chroma_collection() method
