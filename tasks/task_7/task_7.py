...
class QuizGenerator:
    def __init__(self, topic=None, num_questions=1, vectorstore=None):
        ...
        self.vectorstore = Chroma(embedding_function=embed_client)
        self.llm = None
    ...
    def generate_question_with_vectorstore(self):
        ...
        if self.vectorstore is None:
            raise ValueError('self.vectorstore not initialized')
        ...
        system_template = PromptTemplate.from_template(self.system_template)
        ...
        chain = setup_and_retrieval | system_template | self.llm
