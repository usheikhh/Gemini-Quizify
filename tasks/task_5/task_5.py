...
from langchain.text_splitter import CharacterTextSplitter #changed to recursive for better splitting
...
class ChromaCollectionCreator:
    ...
    def create_chroma_collection(self):
        ...
        # Create Chroma in-memory client using the text chunks and the embeddings model
