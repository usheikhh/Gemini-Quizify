    ...
    if 'question_bank' not in st.session_state or len(st.session_state['question_bank']) == 0:
        ...
        with screen.container():
            ...
            with st.form("Load Data to Chroma"):
                ...
                chroma_creator = ChromaCollectionCreator(processor, EmbeddingClient(**embed_config))
                ...
                if submitted:
                    ...
                    generator = QuizGenerator(topic_input, questions,chroma_creator)# Initialize a QuizGenerator class using the topic, number of questions, and the chroma collection
