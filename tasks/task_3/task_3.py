...
class DocumentProcessor:
    ...
    def ingest_documents(self):
        ...
        uploaded_files = st.file_uploader( 
            label= "Upload Files to Break into Chunks", #label was a required parameter
        ...
        if uploaded_files is not None:
            for uploaded_file in uploaded_files:
                ...
                loader = PyPDFLoader(temp_file_path) #this is how you use PyPDF loader according to the docs
                self.pages = loader.load_and_split() #load_and_split() returns a list of documents
